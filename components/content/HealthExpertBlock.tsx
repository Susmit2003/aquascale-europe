...
import { Location } from '@/types'; // Make sure you pass the full location object now, not just city/hardness

interface HealthExpertBlockProps {
  location: Location;
}

export function HealthExpertBlock({ location }: HealthExpertBlockProps) {
