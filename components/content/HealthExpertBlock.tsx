...
export function HealthExpertBlock({ city, hardness }: HealthExpertBlockProps) {
  // Threshold for determining hard vs soft water characteristics
  const isHard = hardness > 120;
  ...
  return (
    <div className="bg-white p-6 md:p-8 rounded-xl border border-slate-200 shadow-sm">
      ...
      <div className="prose prose-blue max-w-none text-slate-700 leading-relaxed mb-6">
        {isHard ? (
          <p>
            Water containing <strong>{hardness} mg/L</strong> of dissolved minerals physically alters how soaps and detergents dissolve. In {city}, households will notice that soaps produce less lather and may leave a harmless mineral film on bathroom surfaces, glass, and fabrics. Because of this restricted lathering efficiency, more detergent and rinse aids are typically needed to achieve standard household cleaning results.
          </p>
        ) : (
          <p>
            Water containing <strong>{hardness} mg/L</strong> of dissolved minerals interacts highly efficiently with soaps and detergents. In {city}, households will notice that soaps produce abundant lather and rinse away easily without leaving mineral residue on bathroom surfaces or fabrics. Because of this efficient lathering, significantly less detergent is typically needed to achieve standard household cleaning results.
          </p>
        )}
      </div>
